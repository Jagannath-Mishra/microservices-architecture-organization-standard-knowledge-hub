...
import com.knowledge.hub.features.platform.web.service.RolesService;
 ...
 * com.knowledge.hub.features.platform.data.model.persistence.RolesEntity}.
 *
 * @author Jagannath Mishra
 */
@Slf4j
@RestController
@RequestMapping(RolesApi.rootEndPoint)
public class RolesApi extends AbstractApi {
    /** Tag for this API. */
    public static final String API_TAG = "Roleses";

    /** Root end point. */
    public static final String rootEndPoint = "/knowledgehub-knowledgehub";

    /** Service implementation of type {@link RolesService}. */
    private final RolesService rolesService;

    /**
     * Constructor.
     *
     * @param rolesService Service instance of type {@link RolesService}.
     */
    public RolesApi(final RolesService rolesService) {
        this.rolesService = rolesService;
    }

    /**
     * This API provides the capability to add a new instance of type {@link
     * com.knowledge.hub.features.platform.data.model.persistence.RolesEntity} into the system.
     *
     * @param payload Payload containing the details required to create an instance of type {@link
     *     com.knowledge.hub.features.platform.data.model.persistence.RolesEntity}.
     * @return Response of type {@link ResponseEntity} that wraps an instance of type {@link Roles}.
     */
    @Operation(
            method = "createRoles",
            summary = "Create a new Roles.",
            description = "This API is used to create a new Roles in the system.",
            tags = {RolesApi.API_TAG},
            security = {
                @SecurityRequirement(
                        name =
    ...
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "201",
                        description = "Successfully created a new Roles in the system.",
                        content = @Content),
                @ApiResponse(
                        responseCode = "403",
    ...
    @PostMapping(value = "/courseses/{coursesId}/contentses/{contentsId}/userses/{usersId}/roleses")
    public ResponseEntity<Roles> createRoles(
            ...
            @Valid @RequestBody final CreateRolesRequest payload) {
        // Delegate to the service layer.
        final Roles newInstance = rolesService.createRoles(coursesId, contentsId, usersId, payload);
     ...
     * com.knowledge.hub.features.platform.data.model.persistence.RolesEntity} in the system.
     *
    ...
    @Operation(
            ...
            description = "This API is used to update an existing Roles in the system.",
            tags = {RolesApi.API_TAG},
            security = {
                @SecurityRequirement(
                        name =
    ...
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Successfully updated an existing Roles in the system.",
                        content = @Content),
                @ApiResponse(
                        responseCode = "403",
                        description = "You do not have permissions to perform this operation.",
    ...
    @PutMapping(
            value =
                    "/courseses/{coursesId}/contentses/{contentsId}/userses/{usersId}/roleses/{rolesId}")
    public ResponseEntity<Roles> updateRoles(
            @PathVariable(name = "coursesId") final String coursesId,
            @PathVariable(name = "contentsId") final String contentsId,
            @PathVariable(name = "usersId") final String usersId,
            @PathVariable(name = "rolesId") final String rolesId,
            @Valid @RequestBody final UpdateRolesRequest payload) {
        // Delegate to the service layer.
        final Roles updatedInstance =
                rolesService.updateRoles(coursesId, contentsId, usersId, rolesId, payload);
    ...
    @Operation(
            method = "findRoles",
            summary = "Find an existing Roles.",
            description = "This API is used to find an existing Roles in the system.",
            tags = {RolesApi.API_TAG},
            security = {
                @SecurityRequirement(
                        name =
    ...
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description =
                                "Successfully retrieved the details of an existing Roles in the system.",
                        content = @Content),
                @ApiResponse(
                        responseCode = "403",
                        description = "You do not have permissions to perform this operation.",
    ...
    @GetMapping(
            value =
                    "/courseses/{coursesId}/contentses/{contentsId}/userses/{usersId}/roleses/{rolesId}")
    public ResponseEntity<Roles> findRoles(
            @PathVariable(name = "coursesId") final String coursesId,
            @PathVariable(name = "contentsId") final String contentsId,
            @PathVariable(name = "usersId") final String usersId,
            @PathVariable(name = "rolesId") final String rolesId) {
        // Delegate to the service layer.
        final Roles matchingInstance =
                rolesService.findRoles(coursesId, contentsId, usersId, rolesId);
     ...
     *     {@link com.knowledge.hub.features.platform.data.model.persistence.RolesEntity} that was
     *     deleted from the system.
     */
    @Operation(
            method = "deleteRoles",
            summary = "Delete an existing Roles.",
            description = "This API is used to delete an existing Roles in the system.",
            tags = {RolesApi.API_TAG},
            security = {
                @SecurityRequirement(
                        name =
    ...
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Successfully deleted an existing Roles in the system.",
                        content = @Content),
                @ApiResponse(
                        responseCode = "403",
                        description = "You do not have permissions to perform this operation.",
    ...
    public ResponseEntity<String> deleteRoles(
            ...
            @PathVariable(name = "rolesId") final String rolesId) {
        // Delegate to the service layer.
        final String deletedInstance =
                rolesService.deleteRoles(coursesId, contentsId, usersId, rolesId);
