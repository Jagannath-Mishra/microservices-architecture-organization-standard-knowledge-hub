 ...
 */
package com.knowledge.hub.security.access;

import org.springframework.security.core.Authentication;

import com.knowledge.hub.security.userdetails.IExtendedUserDetails;
import com.knowledge.hub.security.utils.AuthenticationUtils;
...
public interface IPermissionEvaluator {
     ...
     *
     * @param userPrincipal
     *         Authenticated user of type {@link com.knowledge.hub.security.userdetails.IExtendedUserDetails}
     * @param permissionCode
     *         Unique identifier of the permission
     *
     * @return True if the current authenticated user has the permissions for the respective permission code else
